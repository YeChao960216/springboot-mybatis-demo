...
import com.example.springbootmybatisgeneratortest.entity.User;
...
public class Hbase {
    ...
    public static Connection initHbase() throws IOException {
        ...
        configuration.set("hbase.zookeeper.quorum", "192.168.43.140,192.168.43.196,192.168.43.41");
        //集群配置↓
        //configuration.set("hbase.zookeeper.quorum", "101.236.39.141,101.236.46.114,101.236.46.113");
        configuration.set("hbase.master", "192.168.43.140:60000");
