...
CREATE TABLE `chemicals` (
  `chemicals_id` varchar(45) NOT NULL COMMENT '肥料、药品施用编号',
  `grow_id` varchar(45) DEFAULT NULL COMMENT '种植批次编号',
...
CREATE TABLE `company` (
  `company_id` varchar(45) NOT NULL COMMENT '中间厂商',
...
CREATE TABLE `grow` (
  `grow_id` varchar(45) NOT NULL COMMENT '种植批次编号',
  `grower_id` varchar(45) DEFAULT NULL COMMENT '种植户编号',
...
CREATE TABLE `growers` (
  `growers_id` varchar(36) NOT NULL COMMENT '种植户编号',
...
CREATE TABLE `manufacture` (
  `manufacture_id` varchar(36) NOT NULL COMMENT '加工编号',
  `company_id` varchar(36) DEFAULT NULL COMMENT '加工厂商编号',
  `grow_id` varchar(36) DEFAULT NULL COMMENT '种植批次编号',
...
CREATE TABLE `privilege` (
  `privilege_id` varchar(36) NOT NULL COMMENT '权限编号',
...
CREATE TABLE `role_privilege` (
  `role_privilege_id` varchar(45) NOT NULL COMMENT '角色权限关系编号',
  `role_id` varchar(45) DEFAULT NULL COMMENT '角色编号',
  `privilege_id` varchar(45) DEFAULT NULL COMMENT '权限编号',
...
CREATE TABLE `trans` (
  ...
  `grow_id` varchar(45) DEFAULT NULL COMMENT '种植批次编号',
  `manufacture_id` varchar(45) DEFAULT NULL COMMENT '加工编号',
...
CREATE TABLE `user_role` (
  `user_role_id` varchar(45) NOT NULL COMMENT '用户权限关系编号',
  `role_id` varchar(45) DEFAULT NULL COMMENT '角色编号',
